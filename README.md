...
- Small change only to the Display.Misc method name (single underscore instead of 2).
  - This brings it in line with the blog about  this at [Softata API Version 3](https://djzblogaccname137.z26.web.core.windows.net/softata/Softata-API_Version_3-softata.html)
